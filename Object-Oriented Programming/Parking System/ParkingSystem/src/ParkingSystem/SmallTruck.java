...
public class SmallTruck extends Vehicle {
    ...
    public SmallTruck( int VehicleNumber,Time time)
    {
    ...
    public double GetAdditionalCost()
    {
        ...
        {
            AdditionalCost =  this.getTime().getDay() * 48000 + this.getTime().getHour() * 2000 ;
    ...
    {
        String string = "차량 종류 : 소형 트럭" + ", 차량번호 : " + this.getVehicleNumber() + ", 입차 시간 : " + this.getTime().getYear()
