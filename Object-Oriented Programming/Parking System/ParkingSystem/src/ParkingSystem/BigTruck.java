...
public class BigTruck extends Vehicle {
    ...
    public BigTruck( int VehicleNumber,Time time)
    {
    ...
    public double GetAdditionalCost()
    {
        ...
        else if(this.getTime().getDay() >=1 && this.getTime().getHour() >= 1 && this.getTime().getMinute() > 0)
        {
            AdditionalCost =  this.getTime().getDay() * 96000 + this.getTime().getHour() * 4000 ;
    ...
    {
        String string = "차량 종류 : 대형 트럭" + ", 차량번호 : " + this.getVehicleNumber() + ", 입차 시간 : " + this.getTime().getYear()
